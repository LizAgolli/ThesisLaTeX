...
% REMOVE: \usepackage{sectsty}  % Incompatible with amsbook
% REMOVE: \usepackage{titletoc}  % Conflicts with amsbook
...
\noindent
This document is in an accessible EPUB format. A PDF version of this document is available at https://github.com/LizAgolli/ThesisPDF or can be obtained by contacting Elizabeth Agolli at lizagolli@gmail.com.
...
BAM  \tab Binary Alignment Map \\
CI   \tab Credibility interval \\
CL   \tab Control lineage\\
CSD  \tab Cumulative selection differential\\
DGRP \tab Drosophila Genetic Reference Panel\\
E\&R \tab Evolve \& Resequence\\
FVW  \tab Fenn Valley Winery\\
GWAS \tab Genome wide association study\\
HL   \tab High sexual size dimorphism lineage\\
HR   \tab Hazard ratio \\
IASC \tab Intralocus sexual conflict\\
ICSD \tab Indirect cumulative selection differential \\
IIS  \tab Insulin-like/IGF signaling\\
LL   \tab Low sexual size dimorphism lineage\\
MVW  \tab Minimal viable weight\\
SAM  \tab Sequence Alignment Map \\
SDM  \tab Sex determination mechanism\\
SNP  \tab Single nucleotide polymorphism\\
SSD  \tab Sexual size dimorphism\\
SSP  \tab Sex-specific plasticity\\
TGP  \tab Terminal growth period\\
TOR  \tab  Target of Rapamycin\\
\end{doublespacing}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.7\textwidth]{sexspecifichormones.jpg}
    \caption{from Shingleton and Vea (2023). Functional parts of the cascade are shown in black, non-functional parts are shown in gray. The possession of two X chromosomes leads to the synthesis of Sxl, which splices \textit{tra} pre-mRNA to generate a functional protein in females only. Functional Tra in turn splices \textit{dsx} pre-mRNA to generate the female isoform of Dsx (DsxF). In males, in the absence of Sxl and functional Tra, \textit{dsx} pre-mRNA is spliced to generate the male isoform of Dsx (DsxM). Functional Tra also directs the splicing of \textit{fru} pre-mRNA into a female isoform (\textit{fruF}) that is not translated, while the absence of functional Tra in males results in the default splicing of \textit{fru} pre-mRNA into a male isoform (\textit{fruM}) that is translated into functional protein. Active Sxl also suppresses the synthesis of the dosage compensation protein msl-2 in females, which otherwise heightens the activity of the single X chromosomes in males. Here and in all other figures, female is purple an male is green.}
    \Discription{from Shingleton and Vea (2023). Functional parts of the cascade are shown in black, non-functional parts are shown in gray. The possession of two X chromosomes leads to the synthesis of Sxl, which splices tra pre-mRNA to generate a functional protein in females only. Functional Tra in turn splices dsx pre-mRNA to generate the female isoform of Dsx (DsxF). In males, in the absence of Sxl and functional Tra, dsx pre-mRNA is spliced to generate the male isoform of Dsx (DsxM). Functional Tra also directs the splicing of fru pre-mRNA into a female isoform (fruF) that is not translated, while the absence of functional Tra in males results in the default splicing of fru pre-mRNA into a male isoform (fruM) that is translated into functional protein. Active Sxl also suppresses the synthesis of the dosage compensation protein msl-2 in females, which otherwise heightens the activity of the single X chromosomes in males. Here and in all other figures, female is purple an male is green.}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{testafig1.jpg}
...
\begin{figure}[b!]
    \centering
    \includegraphics[width=0.6\textwidth]{testafig2.jpg}
...
\subsection{Identifying Mechanisms That Underlie SSD}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\textwidth]{Generation Selection Layout.jpeg}
...
\begin{figure}[b!]
    \centering
    \includegraphics[width=0.8\textwidth]{mating scheme.JPG}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{FVW_R2.png}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.85\textwidth]{CSDfig.png}
...
\begin{figure}[b]
    \centering
        \centering
        \includegraphics[width=\linewidth]{bothChiHits.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{manGWASandChi.png}
...
\begin{figure}
        \centering
        \includegraphics[width=1\linewidth]{vennElipseScale.png}
...
\begin{table}
    ...
    \begin{tabular}{rcccl}
        ...
        \textit{Pde1c}      & \(\bullet \)    & \(\bullet \) & & signal transduction, cGMP metabolic process, and cAMP metabolic process \\ \hline
...
The difference between male and female body size (sexual size dimorphism, SSD) is one of the most obvious ways in which the sexes differ. In \textit{Drosophila melanogaster}, as in most arthropods, females are the larger sex (Webb \& Freckleton, 2007; Testa et al., 2013, Audet et al., 2024). Research over the last thirty years has established the developmental, genetic, and physiological mechanisms that regulate body size, much of which has been done in \textit{D. melanogaster}. It is well understood that females and males are essentially genetically identical and that sex determination leads to differences in gene expression, which ultimately generate SSD (Lande, 1980; Bonduriansky \& Chenoweth, 2009; Sayadi et al., 2019; Audet et al., 2024). However, while sex determination and the selective pressures that produce observed patterns of SSD have been well studied, how SSD occurs at the developmental-genetic level remains largely unknown. Understanding what happens when SSD is experimentally altered, both in terms of the developmental mechanisms that change and the broader consequences for organismal fitness, can provide insight into how SSD is evolved and maintained.
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{combinedSSD.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{MVW_combined_full.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=1\linewidth]{durationCombinedAdj.png}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=1\linewidth]{growth_rate_combined_adj.png}
...
\begin{figure}
        \centering
        \includegraphics[width=0.75\linewidth]{SurvivalFig.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{facet_ssp.png}
    \caption{Sex specific scaling of the wing against body size facet by lineage.}
    \label{fig:scaling}
\end{figure}
...
\nocite{*} \renewcommand{\bibname}{Cited Literature} 
\singlespacing
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{rawplots.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{FvMpoint.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{FvMpath.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{MCMCGLMMplot1.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{MCMCGLMMplot2.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{MCMCGLMMplot3.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{piplot.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{Fst.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{isoSSDbySex.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{MVW_sup.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{durationCombined.png}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=1\linewidth]{growth_rate_combined.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{testaetalcopyright.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{shingletonandveacopyright.png}
